...
export default function Navbar() {
  ...
  // Always solid: dark green on home hero, white on scroll / other pages
  ...
  return (
    ...
    >
      ...
      {/* Mobile menu */}
      <div
        className={`mobile-menu bg-white border-t border-brand-100 ${mobileOpen ? "open" : ""}`}
      >
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1">
          ...
          <div className="mt-3 pt-3 border-t border-brand-100 flex gap-3">
            <a href="tel:+61432057619" className="btn-secondary flex-1 justify-center text-sm py-2.5">
              Call Now
            </a>
