...
> **Paste these instructions into a Claude Project** and Claude will generate fully designed, brand-consistent Instagram carousels in one conversation.
> 
...
2. Create a **New Project** — name it something like "Instagram Carousels"
3. Click **"Set project instructions"**
4. **Copy everything in the box below** and paste it into the instructions field
5. Save — and start generating carousels inside that project
6. Do not forget to give images to Claude it will include them into the carousel

> 💡 Claude will ask for your brand name and some other basic questions
> 
...
- **Include images** that you want to be included inside the carousel
- **Give Claude your website URL** — it'll pull brand colors and style automatically.
- **Don't like a slide?** Say *"redo slide 3 with a darker background and shorter headline"*
- **Want a different vibe?** Say *"make it more minimal"* or *"go bolder on the typography"*