...
// Pixel-percentage positions of every red dot in /public/roof-demo-images/coverage.png
...
const STATUS_META: Record<Status, {
  ...
  in_talks:  { label: "In talks",     short: "in talks",  Icon: MessageSquare, bg: "linear-gradient(135deg, #0071E3, #005FC0)",  ringClass: "bg-gold/30",        textColor: "#0071E3", pillBg: "bg-gold/10",     pillText: "text-gold-deep" },
...
function CoverageCanvas({
  ...
  return (
    <div className="relative bg-ink select-none" style={{ aspectRatio: `${VB_W} / ${VB_H}` }}>
      <img
        src="/roof-demo-images/coverage.png"
