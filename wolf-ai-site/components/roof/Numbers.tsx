        ...
        >
          ...
          <div className="grid grid-cols-2 relative">
            ...
            <div
              ...
              style={{ background: "#0B0D12", borderBottom: "1px solid rgba(232, 222, 201, 0.10)" }}
            >
              ...
              <div className="min-w-0">
                ...
                <div className="font-display text-[13px] sm:text-[15px] font-extrabold tracking-tight truncate" style={{ color: "#DCE9FB" }}>
            ...
            <div
              className="px-4 sm:px-6 py-4 sm:py-5 flex items-center gap-2 sm:gap-2.5"
              style={{ background: "#F4F8FE", borderBottom: "1px solid rgba(10, 10, 10, 0.06)" }}
            >
