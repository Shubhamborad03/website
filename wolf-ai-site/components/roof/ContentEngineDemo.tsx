        ...
        >
          <div className="grid grid-cols-2 aspect-[16/8]">
            <div className="relative">
              <Image src="/roof-demo-images/before-1.png" alt="Before" fill sizes="(max-width: 768px) 50vw, 600px" className="object-cover" />
            ...
            <div className="relative">
              <Image src="/roof-demo-images/after-1.png" alt="After" fill sizes="(max-width: 768px) 50vw, 600px" className="object-cover" />
