...
const DETAIL_IMAGES = [
  { img: "/roof-demo-images/before-1.png", label: "ROOF AGE & MOSS",  issue: "Heavy moss · ~28yr tile",     measure: "218m²", point: { x: 48, y: 42 } },
  { img: "/roof-demo-images/before-2.png", label: "STORM DAMAGE",     issue: "Hail-impact zone · north",    measure: "184m²", point: { x: 60, y: 38 } },
  { img: "/roof-demo-images/before-4.png", label: "SURFACE WEAR",     issue: "Coating breakdown",           measure: "145m²", point: { x: 50, y: 45 } },
];
      ...
      <div className="max-w-5xl mx-auto px-5 lg:px-12">
        ...
        >
          <div className="relative aspect-[16/10]">
            <Image
              src="/roof-demo-images/before-3.png"
            ...
            >
              ...
              {DAMAGE_CALLOUTS.map((d, i) => (
                ...
                >
                  ...
                  <circle cx={d.tx} cy={d.ty} r="0.6" fill="#0071E3" />
                  <circle cx={d.tx} cy={d.ty} r="1.4" fill="none" stroke="#0071E3" strokeWidth="0.2" opacity="0.5" />
                </motion.g>
              ))}
            </svg>
...
function Crosshair({ inView, cx, cy }: { inView: boolean; cx: number; cy: number }) {
  ...
  return (
    ...
    >
      {/* Outer ring */}
      <circle cx={cx} cy={cy} r={arm * 0.9} fill="rgba(0, 113, 227,0.08)" stroke="#0071E3" strokeOpacity="0.6" />
      {/* Crosshair arms */}
      ...
      {/* Center dot */}
      <circle cx={cx} cy={cy} r="0.5" fill="#0071E3" stroke="none" />
    </motion.g>
  );
}
